...
def main():
    ...
    for taskID in range(t1, t2):
        ...
        vwrite(
            visualDir + '%s_%s_%s_%d_cloth.mp4' %
                (studioTag, studioSubTag, testDataNickName, index),
            cloth * 255.,
        )
        ...
        # vwrite(
        #     visualDir + '%s_%s_%s_%d_debug1.mp4' %
        #     (studioTag, studioSubTag, testDataNickName, index),
        #     debug1 * 255.,
        # )

        vwrite(
            visualDir + '%s_%s_%s_%d_oursOnly.mp4' %
            (studioTag, studioSubTag, testDataNickName, index),
