        ...
        class DTrainer(Trainer):
            ...
            def forwardNetForCorenet(cls, batch_thgpu, **kwargs):
                ...
                for samplingMethod in ['nearsurfacemass', 'nearsurfaceair', 'nonsurface']:
                    pCam = batch_thgpu[
                        'final%sPCxyzCam_corenetChoySingleRendering' % bt(samplingMethod)].requires_grad_(True)
                    pCamPersp = camSys2CamPerspSysTHGPU(
                        pCam,
                        batch_thgpu['focalLengthWidth_corenetChoySingleRendering'],
                        batch_thgpu['focalLengthHeight_corenetChoySingleRendering'],
                        batch_thgpu['winWidth_corenetChoySingleRendering'],
                        batch_thgpu['winHeight_corenetChoySingleRendering'])
