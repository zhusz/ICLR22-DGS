...
def getConfigFunc(P, D, S, R, **kwargs):
    ...
    config.datasetConfDict['scannetGivenRender']['samplingMethodList'] = [
        'fullsurface', 'nearsurface', 'selfnonsurface',
        'unarysurface', 'localPlanarPairwiseSurface', 'localEdgePairwiseSurface']

    config.datasetConfDict['scannetGivenRender']['fullsurfaceNumNearestNeighbour'] = 5

    config.datasetConfDict['scannetGivenRender']['numSamplingFinalUnarysurface'] = 1024
    config.datasetConfDict['scannetGivenRender']['numSamplingSufficientUnarysurface'] = 1024 * 8
    config.datasetConfDict['scannetGivenRender']['numSamplingFinalLocalPlanarPairwiseSurface'] = 512
    config.datasetConfDict['scannetGivenRender']['numSamplingSufficientLocalPlanarPairwiseSurface'] = 512 * 8
    config.datasetConfDict['scannetGivenRender']['numSamplingFinalLocalEdgePairwiseSurface'] = 512
    config.datasetConfDict['scannetGivenRender']['numSamplingSufficientLocalEdgePairwiseSurface'] = 512 * 8

    config.wl['lossUnarysurfaceNormal'] = 0.1666
    config.wl['lossLocalPlanarPairwiseSurfaceNormal'] = 0.1667
    config.wl['lossLocalEdgePairwiseSurfaceNormal'] = 0.1667
