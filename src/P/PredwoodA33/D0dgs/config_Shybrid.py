...
def getConfigFunc(P, D, S, R, **kwargs):  # Abstract Config
    ...
    config.datasetConfDict['scannetGivenRender'] = {
        'dataset': 'scannetGivenRender', 'trainingSplit': 'train', 'batchSize': 32,
        'class': 'ScannetGivenRenderDataset',
    ...
    config.c_dim_specs = {'s1': 256, 's2': 512, 's3': 768, 's4': 768}
