        ...
        class DTrainer(Trainer):
            ...
            def forwardNet(cls, batch_thgpu, **kwargs):
                ...
                for samplingMethod in ['nearsurfacemass', 'nearsurfaceair', 'nonsurface']:
                    pCam = batch_thgpu['final%sPCxyzCam' % bt(samplingMethod)].requires_grad_(True)
                    ...
                    if samplingMethod in ['nearsurfacemass', 'nearsurfaceair']:
                        ...
                        batch_thgpu['final%sPCpredGradBisem' % bt(samplingMethod)] = \
            ...
            def forwardLoss(cls, batch_thgpu, **kwargs):
                ...
                if wl['lossNonsurfaceClfGradZero'] > 0:
                    predGrad = batch_thgpu['final%sPCpredGradBisem' % bt('nonsurface')]
            ...
            def doQueryPred0(img0, queryPointCam0, queryPointCamPersp0, **kwargs):
                ...
                for batchID in range(batchTot):
                    ...
                    out = torch.sigmoid(networkTwo(positionalEncoder(
                        pCam.view(-1, 3).contiguous(), forwardMode='valOnly').contiguous(), phi, forwardMode='valOnly'))[:, 0]
